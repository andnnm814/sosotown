        ...
        <div class="sidebar">
            <form action="" method="get" class="search-box">
                ...
                <dl>
                    ...
                    <dd><input type="text" name="keyword" class="input-box" placeholder="" value=""></dd>

                    <dt class="search-title">価格帯</dt>
                    <dd>
                        <div>
                            <input type="text" name="min_price" class="input-box" placeholder="円" value="">
                            <span class="">〜</span>
                            <input type="text" name="max_price" class="input-box" placeholder="円" value="">
                        </div>
                    </dd>
